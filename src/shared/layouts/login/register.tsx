...
export const Register = () => {
  ...
  const handleRegister = async ({ name, email, password, username }: any) => {
    try {
      const response = await loginUser({ email, password, name, username })
      ...
      <div className="w-full flex flex-wrap">
        <div className="w-full md:w-1/2 flex flex-col">
          ...
          <div className="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
            ...
            <Form className="mt-10" name="basic" onFinish={handleRegister} layout="vertical">
              <Form.Item
                initialValue="Diana Oquendo"
              ...
              >
                <Input className="shadow appearance-none border rounded w-full py-4 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline" />
              </Form.Item>
              <Form.Item
                initialValue="rainbowsAndUnicorns"
                className="flex flex-col pt-4"
              ...
              >
                <Input.Password className="shadow appearance-none border rounded w-full py-4 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline" />
              </Form.Item>
        ...
        <div className="w-1/2 shadow-2xl">
          <img className="object-cover w-full h-screen hidden md:block" src={loginImage} />
        </div>
      </div>
    </body>
  )
